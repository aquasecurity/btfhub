...
> `BTF = -` and `HUB = Y` -- The kernel does not support BTF but is capable of BPF. External files
> from this HUB are needed and btfhub.io API will provide you with needed BTF file.

### [Alma](https://en.wikipedia.org/wiki/AlmaLinux)

| Alma Ver  | RHEL | Release Date  | RHEL Date  | Kernel     | BTF | HUB |
|-----------|------|---------------|------------|------------|-----|-----|
| 8.3       | 8.3  | 2021-03-30    | 2020-11-03 | 4.18.0-240 | Y   | -   |
| 8.4       | 8.4  | 2021-05-26    | 2021-05-18 | 4.18.0-305 | Y   | -   |
| ...       | ...  | ...           | ...        | ...        | Y   | -   |
...
| Centos Ver | RHEL | Release Date | RHEL Date  | Kernel      | BTF | HUB |
|------------|------|--------------|------------|-------------|-----|-----|
...
| 7.6.1810   | 7.6  | 2018-10      | 2018-10-30 | 3.10.0-957  | -   | Y   |
| 7.7.1908   | 7.7  | 2019-08      | 2019-08-06 | 3.10.0-1062 | -   | Y   |
| 7.8.2003   | 7.8  | 2020-03      | 2020-03-31 | 3.10.0-1127 | -   | Y   |
| 7.9.2009 * | 7.9  | 2020-09      | 2020-09-29 | 3.10.0-1160 | -   | Y   |
...
| 8.2.2004   | 8.2  | 2020-06-15   | 2020-04-28 | 4.18.0-193  | Y   | -   |
| 8.3.2011   | 8.3  | 2020-12-07   | 2020-11-03 | 4.18.0-240  | Y   | -   |
| 8.4.2105 * | 8.4  | 2021-06-03   | 2021-05-18 | 4.18.0-305  | Y   | -   |
| ...        | ...  | ...          | ...        | ...         | Y   | -   |

> **Note**: All next kernels from CentOS 8 releases will likely have BTF support enabled

##### CentOS Stream 8

| Stream Ver | RHEL | Release Date | RHEL Date  | Kernel      | BTF | HUB |
|------------|------|--------------|------------|-------------|-----|-----|
|            |      |              |            |             |     |     |

> **Note**: All kernels from CentOS Stream 8 releases have BTF support enabled
>
> \* Latest Version
...
| Ubuntu Ver | Num     | Release Date | Kernel  | BTF | HUB |
|------------|---------|--------------|---------|-----|-----|
| Bionic     | 18.04.2 | 2018-04-26   | 4.15.0  | -   | -   |
| Bionic HWE | -       | -            | 5.4.0   | -   | Y   |
| Focal      | 20.04.2 | 2020-04-23   | 5.4.0   | -   | Y   |
| Focal HWE  | -       | -            | 5.8.0   | -   | Y   |
| Groovy     | 20.10   | 2020-10-22   | 5.8.0   | Y   | -   |
| Groovy HWE | 20.10   | -            | 5.11.0	| Y   | -   |
| Hirsute *  | 21.04   | 2021-04-22   | 5.11.0	| Y   | -   |
| ...        | ...     | ...          | ...     | Y   | -   |
